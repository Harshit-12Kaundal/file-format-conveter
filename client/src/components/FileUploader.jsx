...
// const FileUploader = ({ id, endpoint, acceptedFormats, icon, fileType }) => {
...
//                     {icon}
//                     <p className="text-sm text-center">Easily convert your files between {fileType} format for free</p>
//                 </div>
//                 <input
//                     type="file"
